...
opentelemetry.log_file=non-default_log_file_value.txt
opentelemetry.log_level=CRITICAL
opentelemetry.log_level_file=TRACE
opentelemetry.log_level_syslog=TRACE
opentelemetry.log_level_win_sys_debug=CRITICAL
opentelemetry.secret_token=non-default_secret_token_123
opentelemetry.server_url=https://non-default_server_url:4321/some/path
opentelemetry.service_name=Non-default Service Name
...
phptAssertSame("ini_get('opentelemetry.log_file')", ini_get('opentelemetry.log_file'), 'non-default_log_file_value.txt');
...
phptAssertSame("ini_get('opentelemetry.log_level')", ini_get('opentelemetry.log_level'), 'CRITICAL');
...
phptAssertSame("ini_get('opentelemetry.log_level_file')", ini_get('opentelemetry.log_level_file'), 'TRACE');
...
if ( ! phptIsOsWindows()) {
    phptAssertSame("ini_get('opentelemetry.log_level_syslog')", ini_get('opentelemetry.log_level_syslog'), 'TRACE');
...
if (phptIsOsWindows()) {
    phptAssertSame("ini_get('opentelemetry.log_level_win_sys_debug')", ini_get('opentelemetry.log_level_win_sys_debug'), 'CRITICAL');
