...
PHP_METHOD(AutoZval, getStringView) {
    ...
    try {
        auto str = opentelemetry::php::AutoZval(arg).getStringView();
...
PHP_METHOD(AutoZval, getLong) {
    ...
    try {
        RETURN_LONG(opentelemetry::php::AutoZval(arg).getLong());
    } catch (std::runtime_error const &e) {
...
PHP_METHOD(AutoZval, getDouble) {
    ...
    try {
        RETURN_DOUBLE(opentelemetry::php::AutoZval(arg).getDouble());
    } catch (std::runtime_error const &e) {
...
PHP_METHOD(AutoZval, getNumberAsDouble) {
    ...
    try {
        RETURN_DOUBLE(opentelemetry::php::AutoZval(arg).getNumberAsDouble());
    } catch (std::runtime_error const &e) {
...
PHP_METHOD(AutoZval, getNumberAsLong) {
    ...
    try {
        RETURN_LONG(opentelemetry::php::AutoZval(arg).getNumberAsLong());
    } catch (std::runtime_error const &e) {
...
PHP_METHOD(AutoZval, getBoolean) {
    ...
    try {
        RETURN_BOOL(opentelemetry::php::AutoZval(arg).getBoolean());
    } catch (std::runtime_error const &e) {
...
PHP_METHOD(AutoZval, getArrayCount) {
    ...
    RETURN_LONG(opentelemetry::php::AutoZval(arg).getArrayCount());
}
...
PHP_METHOD(AutoZval, arrayAddNextWithRef) {
    ...
    opentelemetry::php::AutoZval az(array);
...
using RecursiveArrayVisitor_t = std::function<void(opentelemetry::php::AutoZval const &array, std::function<void(opentelemetry::php::AutoZval const &)> const &processElement)>;

void iteratePrintAutoZval(opentelemetry::php::AutoZval const &val, RecursiveArrayVisitor_t const &arrayVisitor) {
    auto recurse = [&](opentelemetry::php::AutoZval const &v) { iteratePrintAutoZval(v, arrayVisitor); };
...
PHP_METHOD(AutoZval, iterateArray) {
    ...
    opentelemetry::php::AutoZval value(val);
