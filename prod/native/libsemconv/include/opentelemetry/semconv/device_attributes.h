 ...
 * <p>
 * See <a href="/docs/registry/attributes/app.md#app-installation-id">@code app.installation.id @endcode</a> for a more privacy-preserving alternative.</blockquote>
 */
static constexpr const char *kDeviceId
 = "device.id";

/**
 * The name of the device manufacturer
 * <p>
 * The Android OS provides this field via <a href="https://developer.android.com/reference/android/os/Build#MANUFACTURER">Build</a>. iOS apps SHOULD hardcode the value @code Apple @endcode.
 */
static constexpr const char *kDeviceManufacturer
 = "device.manufacturer";
 ...
 */
static constexpr const char *kDeviceModelIdentifier
 ...
 */
static constexpr const char *kDeviceModelName
 = "device.model.name";
