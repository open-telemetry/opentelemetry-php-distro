 ...
 * <p>
 * Region name matches the format of @code displayName @endcode in <a href="https://learn.microsoft.com/rest/api/resources/subscriptions/list-locations">Azure Location API</a>
 */
 ...
 */
static constexpr const char *kAzureResourceProviderNamespace
 = "azure.resource_provider.namespace";

/**
 * The unique identifier of the service request. It's generated by the Azure service and returned with the response.
 */
static constexpr const char *kAzureServiceRequestId
