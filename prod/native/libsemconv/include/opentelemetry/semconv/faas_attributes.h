 ...
 */
static constexpr const char *kFaasColdstart
 = "faas.coldstart";
 ...
 */
static constexpr const char *kFaasCron
 = "faas.cron";

/**
 * The name of the source on which the triggering operation was performed. For example, in Cloud Storage or S3 corresponds to the bucket name, and in Cosmos DB to the database name.
 */
static constexpr const char *kFaasDocumentCollection
 = "faas.document.collection";

/**
 * The document name/table subjected to the operation. For example, in Cloud Storage or S3 is the name of the file, and in Cosmos DB the table name.
 */
static constexpr const char *kFaasDocumentName
 = "faas.document.name";

/**
 * Describes the type of the operation that was performed on the data.
 */
static constexpr const char *kFaasDocumentOperation
 ...
 */
static constexpr const char *kFaasDocumentTime
 = "faas.document.time";
 ...
 * </ul>
 */
static constexpr const char *kFaasInstance
 = "faas.instance";

/**
 * The invocation ID of the current function invocation.
 */
static constexpr const char *kFaasInvocationId
 = "faas.invocation_id";
 ...
 */
static constexpr const char *kFaasInvokedName
 = "faas.invoked_name";
 ...
 */
static constexpr const char *kFaasInvokedProvider
 ...
 */
static constexpr const char *kFaasInvokedRegion
 = "faas.invoked_region";

/**
 * The amount of memory available to the serverless function converted to Bytes.
 * <p>
 * It's recommended to set this attribute since e.g. too little memory can easily stop a Java AWS Lambda function from working correctly. On AWS Lambda, the environment variable @code AWS_LAMBDA_FUNCTION_MEMORY_SIZE @endcode provides this information (which must be multiplied by 1,048,576).
 */
static constexpr const char *kFaasMaxMemory
 = "faas.max_memory";
 ...
 * <a href="/docs/general/attributes.md#source-code-attributes">@code code.namespace @endcode/@code code.function.name @endcode</a>
 * span attributes).
 * <p>
 ...
 * <ul>
 *   <li><strong>Azure:</strong>  The full name @code <FUNCAPP>/<FUNC> @endcode, i.e., function app name
 * followed by a forward slash followed by the function name (this form
 * can also be seen in the resource JSON for the function).
 * This means that a span attribute MUST be used, as an Azure function
 * app can host multiple functions that would usually share
 * a TracerProvider (see also the @code cloud.resource_id @endcode attribute).</li>
 * </ul>
 */
static constexpr const char *kFaasName
 = "faas.name";
 ...
 */
static constexpr const char *kFaasTime
 = "faas.time";

/**
 * Type of the trigger which caused this function invocation.
 */
static constexpr const char *kFaasTrigger
 = "faas.trigger";
 ...
 * <a href="https://cloud.google.com/run/docs/container-contract#services-env-vars">@code K_REVISION @endcode environment variable</a>.</li>
 *   <li><strong>Azure Functions:</strong> Not applicable. Do not set this attribute.</li>
 * </ul>
 */
static constexpr const char *kFaasVersion
 = "faas.version";
