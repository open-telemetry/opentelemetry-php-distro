...
>
CreateSyncInt64MetricFaasColdstarts
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricFaasColdstarts
,
    descrMetricFaasColdstarts
,
...
>
CreateSyncDoubleMetricFaasColdstarts
(metrics::Meter *meter)
{
...
>
CreateAsyncInt64MetricFaasColdstarts
(metrics::Meter *meter)
{
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricFaasColdstarts
(metrics::Meter *meter)
{
...
>
CreateSyncInt64MetricFaasCpuUsage
(metrics::Meter *meter)
{
...
>
CreateSyncDoubleMetricFaasCpuUsage
(metrics::Meter *meter)
{
...
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricFaasErrors
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricFaasErrors
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricFaasErrors
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricFaasErrors
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
...
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricFaasInitDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricFaasInitDuration
,
    descrMetricFaasInitDuration
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricFaasInitDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricFaasInvocations
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricFaasInvocations
,
    descrMetricFaasInvocations
,
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricFaasInvocations
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricFaasInvocations
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricFaasInvocations
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
...
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricFaasInvokeDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricFaasInvokeDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricFaasMemUsage
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricFaasMemUsage
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricFaasNetIo
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricFaasNetIo
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricFaasTimeouts
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricFaasTimeouts
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricFaasTimeouts
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricFaasTimeouts
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
