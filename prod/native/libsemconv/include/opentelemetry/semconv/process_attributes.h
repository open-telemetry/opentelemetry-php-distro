 ...
 */
static constexpr const char *kProcessArgsCount
 = "process.args_count";

/**
 * The command used to launch the process (i.e. the command name). On Linux based systems, can be set to the zeroth string in @code proc/[pid]/cmdline @endcode. On Windows, can be set to the first parameter extracted from @code GetCommandLineW @endcode.
 */
static constexpr const char *kProcessCommand
 = "process.command";
 ...
 */
static constexpr const char *kProcessExecutableBuildIdGnu
 = "process.executable.build_id.gnu";

/**
 * The Go build ID as retrieved by @code go tool buildid <go executable> @endcode.
 */
static constexpr const char *kProcessExecutableBuildIdGo
...
/**
 * The name of the process executable. On Linux based systems, this SHOULD be set to the base name of the target of @code /proc/[pid]/exe @endcode. On Windows, this SHOULD be set to the base name of @code GetProcessImageFileNameW @endcode.
 */
static constexpr const char *kProcessExecutableName
 = "process.executable.name";

/**
 * The full path to the process executable. On Linux based systems, can be set to the target of @code proc/[pid]/exe @endcode. On Windows, can be set to the result of @code GetProcessImageFileNameW @endcode.
 */
static constexpr const char *kProcessExecutablePath
 = "process.executable.path";

/**
 * The exit code of the process.
 */
static constexpr const char *kProcessExitCode
 = "process.exit.code";

/**
 * The date and time the process exited, in ISO 8601 format.
 */
static constexpr const char *kProcessExitTime
 = "process.exit.time";
 ...
 */
static constexpr const char *kProcessInteractive
 = "process.interactive";
 ...
 */
static constexpr const char *kProcessLinuxCgroup
 = "process.linux.cgroup";

/**
 * The username of the user that owns the process.
 */
static constexpr const char *kProcessOwner
 = "process.owner";
 ...
 */
static constexpr const char *kProcessParentPid
 = "process.parent_pid";
 ...
 */
static constexpr const char *kProcessRuntimeDescription
 ...
 */
static constexpr const char *kProcessRuntimeVersion
 ...
 */
static constexpr const char *kProcessTitle
 = "process.title";
 ...
 */
static constexpr const char *kProcessVpid
 = "process.vpid";

/**
 * The working directory of the process.
 */
static constexpr const char *kProcessWorkingDirectory
