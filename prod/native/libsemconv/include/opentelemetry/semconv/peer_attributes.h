 ...
 *   <li>A gRPC service @code rpc.service="io.opentelemetry.AuthService" @endcode may be hosted in both a gateway, @code peer.service="ExternalApiService" @endcode and a backend, @code peer.service="AuthService" @endcode.</li>
 * </ul>
 */
