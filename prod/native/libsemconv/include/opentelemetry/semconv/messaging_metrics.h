...
static constexpr const char *descrMetricMessagingClientConsumedMessages
 = "Number of messages that were delivered to the application.";
static constexpr const char *unitMetricMessagingClientConsumedMessages
 = "{message}";

static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingClientConsumedMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingClientConsumedMessages
,
...
>
CreateSyncDoubleMetricMessagingClientConsumedMessages
(metrics::Meter *meter)
{
...
>
CreateAsyncInt64MetricMessagingClientConsumedMessages
(metrics::Meter *meter)
{
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingClientConsumedMessages
(metrics::Meter *meter)
{
...
static constexpr const char *descrMetricMessagingClientOperationDuration
 = "Duration of messaging operation initiated by a producer or consumer client.";
static constexpr const char *unitMetricMessagingClientOperationDuration
 = "s";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricMessagingClientOperationDuration
(metrics::Meter *meter)
{
...
>
CreateSyncDoubleMetricMessagingClientOperationDuration
(metrics::Meter *meter)
{
...
OPENTELEMETRY_DEPRECATED
static constexpr const char *unitMetricMessagingClientPublishedMessages
 = "{message}";

OPENTELEMETRY_DEPRECATED
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingClientPublishedMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingClientPublishedMessages
,
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricMessagingClientPublishedMessages
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingClientPublishedMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
...
static constexpr const char *descrMetricMessagingClientSentMessages
 = "Number of messages producer attempted to send to the broker.";
static constexpr const char *unitMetricMessagingClientSentMessages
 = "{message}";

static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingClientSentMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingClientSentMessages
,
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricMessagingClientSentMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricMessagingClientSentMessages
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingClientSentMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
 ...
 * histogram
 */
static constexpr const char *kMetricMessagingProcessDuration
 = "messaging.process.duration";
static constexpr const char *descrMetricMessagingProcessDuration
 = "Duration of processing operation.";
static constexpr const char *unitMetricMessagingProcessDuration
 = "s";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricMessagingProcessDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricMessagingProcessDuration
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricMessagingProcessDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
 ...
 */
OPENTELEMETRY_DEPRECATED
static constexpr const char *kMetricMessagingProcessMessages
 = "messaging.process.messages";
OPENTELEMETRY_DEPRECATED
static constexpr const char *descrMetricMessagingProcessMessages
 = "Deprecated. Use `messaging.client.consumed.messages` instead.";
OPENTELEMETRY_DEPRECATED
static constexpr const char *unitMetricMessagingProcessMessages
 = "{message}";

OPENTELEMETRY_DEPRECATED
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingProcessMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingProcessMessages
,
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricMessagingProcessMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricMessagingProcessMessages
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingProcessMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
 ...
 */
OPENTELEMETRY_DEPRECATED
static constexpr const char *kMetricMessagingPublishDuration
 = "messaging.publish.duration";
OPENTELEMETRY_DEPRECATED
static constexpr const char *descrMetricMessagingPublishDuration
 = "Deprecated. Use `messaging.client.operation.duration` instead.";
OPENTELEMETRY_DEPRECATED
static constexpr const char *unitMetricMessagingPublishDuration
 = "s";

OPENTELEMETRY_DEPRECATED
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricMessagingPublishDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricMessagingPublishDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
 ...
 */
OPENTELEMETRY_DEPRECATED
static constexpr const char *kMetricMessagingPublishMessages
...
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingPublishMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingPublishMessages
,
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricMessagingPublishMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricMessagingPublishMessages
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingPublishMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
 ...
 */
OPENTELEMETRY_DEPRECATED
static constexpr const char *kMetricMessagingReceiveDuration
 = "messaging.receive.duration";
OPENTELEMETRY_DEPRECATED
static constexpr const char *descrMetricMessagingReceiveDuration
 = "Deprecated. Use `messaging.client.operation.duration` instead.";
OPENTELEMETRY_DEPRECATED
static constexpr const char *unitMetricMessagingReceiveDuration
 = "s";

OPENTELEMETRY_DEPRECATED
static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricMessagingReceiveDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricMessagingReceiveDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
 ...
 */
OPENTELEMETRY_DEPRECATED
static constexpr const char *kMetricMessagingReceiveMessages
 = "messaging.receive.messages";
OPENTELEMETRY_DEPRECATED
static constexpr const char *descrMetricMessagingReceiveMessages
 = "Deprecated. Use `messaging.client.consumed.messages` instead.";
OPENTELEMETRY_DEPRECATED
static constexpr const char *unitMetricMessagingReceiveMessages
 = "{message}";

OPENTELEMETRY_DEPRECATED
static inline nostd::unique_ptr<metrics::Counter<uint64_t>
>
CreateSyncInt64MetricMessagingReceiveMessages
(metrics::Meter *meter)
{
  return meter->CreateUInt64Counter
(
    kMetricMessagingReceiveMessages
,
...
static inline nostd::unique_ptr<metrics::Counter<double>
>
CreateSyncDoubleMetricMessagingReceiveMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricMessagingReceiveMessages
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricMessagingReceiveMessages
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableCounter
(
