 ...
 */
static constexpr const char *kAwsBedrockGuardrailId
 ...
 */
static constexpr const char *kAwsBedrockKnowledgeBaseId
 ...
 */
static constexpr const char *kAwsDynamodbAttributesToGet
 = "aws.dynamodb.attributes_to_get";

/**
 * The value of the @code ConsistentRead @endcode request parameter.
 */
static constexpr const char *kAwsDynamodbConsistentRead
 = "aws.dynamodb.consistent_read";

/**
 * The JSON-serialized value of each item in the @code ConsumedCapacity @endcode response field.
 */
static constexpr const char *kAwsDynamodbConsumedCapacity
 = "aws.dynamodb.consumed_capacity";

/**
 * The value of the @code Count @endcode response parameter.
 */
static constexpr const char *kAwsDynamodbCount
 = "aws.dynamodb.count";

/**
 * The value of the @code ExclusiveStartTableName @endcode request parameter.
 */
static constexpr const char *kAwsDynamodbExclusiveStartTable
 = "aws.dynamodb.exclusive_start_table";

/**
 * The JSON-serialized value of each item in the @code GlobalSecondaryIndexUpdates @endcode request field.
 */
 ...
 */
static constexpr const char *kAwsDynamodbIndexName
 ...
 */
static constexpr const char *kAwsDynamodbLimit
 = "aws.dynamodb.limit";
 ...
 */
static constexpr const char *kAwsDynamodbProjection
 ...
 */
static constexpr const char *kAwsEcsClusterArn
 = "aws.ecs.cluster.arn";
 ...
 */
static constexpr const char *kAwsEcsTaskArn
 = "aws.ecs.task.arn";
 ...
 */
static constexpr const char *kAwsEcsTaskFamily
 = "aws.ecs.task.family";

/**
 * The ID of a running ECS task. The ID MUST be extracted from @code task.arn @endcode.
 */
static constexpr const char *kAwsEcsTaskId
 = "aws.ecs.task.id";

/**
 * The revision for the task definition used to create the ECS task.
 */
static constexpr const char *kAwsEcsTaskRevision
 = "aws.ecs.task.revision";

/**
 * The ARN of an EKS cluster.
 */
static constexpr const char *kAwsEksClusterArn
 = "aws.eks.cluster.arn";

/**
 * The AWS extended request ID as returned in the response header @code x-amz-id-2 @endcode.
 */
static constexpr const char *kAwsExtendedRequestId
 = "aws.extended_request_id";

/**
 * The name of the AWS Kinesis <a href="https://docs.aws.amazon.com/streams/latest/dev/introduction.html">stream</a> the request refers to. Corresponds to the @code --stream-name @endcode parameter of the Kinesis <a href="https://docs.aws.amazon.com/cli/latest/reference/kinesis/describe-stream.html">describe-stream</a> operation.
 */
static constexpr const char *kAwsKinesisStreamName
 = "aws.kinesis.stream_name";

/**
 * The full invoked ARN as provided on the @code Context @endcode passed to the function (@code Lambda-Runtime-Invoked-Function-Arn @endcode header on the @code /runtime/invocation/next @endcode applicable).
 * <p>
 * This may be different from @code cloud.resource_id @endcode if an alias is involved.
 */
static constexpr const char *kAwsLambdaInvokedArn
 ...
 */
static constexpr const char *kAwsLambdaResourceMappingId
 ...
 */
static constexpr const char *kAwsLogGroupArns
 = "aws.log.group.arns";
 ...
 */
static constexpr const char *kAwsLogGroupNames
 = "aws.log.group.names";
 ...
 */
static constexpr const char *kAwsLogStreamArns
 = "aws.log.stream.arns";

/**
 * The name(s) of the AWS log stream(s) an application is writing to.
 */
static constexpr const char *kAwsLogStreamNames
 = "aws.log.stream.names";

/**
 * The AWS request ID as returned in the response headers @code x-amzn-requestid @endcode, @code x-amzn-request-id @endcode or @code x-amz-request-id @endcode.
 */
static constexpr const char *kAwsRequestId
 = "aws.request_id";

/**
 * The S3 bucket name the request refers to. Corresponds to the @code --bucket @endcode parameter of the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/index.html">S3 API</a> operations.
 * <p>
 * The @code bucket @endcode attribute is applicable to all S3 operations that reference a bucket, i.e. that require the bucket name as a mandatory parameter.
 * This applies to almost all S3 operations except @code list-buckets @endcode.
 */
static constexpr const char *kAwsS3Bucket
 = "aws.s3.bucket";

/**
 * The source object (in the form @code bucket @endcode/@code key @endcode) for the copy operation.
 * <p>
 * The @code copy_source @endcode attribute applies to S3 copy operations and corresponds to the @code --copy-source @endcode parameter
 ...
 * </ul>
 */
static constexpr const char *kAwsS3CopySource
 = "aws.s3.copy_source";

/**
 * The delete request container that specifies the objects to be deleted.
 * <p>
 * The @code delete @endcode attribute is only applicable to the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/delete-object.html">delete-object</a> operation.
 * The @code delete @endcode attribute corresponds to the @code --delete @endcode parameter of the
 ...
 */
static constexpr const char *kAwsS3Delete
 = "aws.s3.delete";

/**
 * The S3 object key the request refers to. Corresponds to the @code --key @endcode parameter of the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/index.html">S3 API</a> operations.
 * <p>
 * The @code key @endcode attribute is applicable to all object-related S3 operations, i.e. that require the object key as a mandatory parameter.
 * This applies in particular to the following operations:
 * <ul>
 *   <li><a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/copy-object.html">copy-object</a></li>
 ...
 * </ul>
 */
static constexpr const char *kAwsS3Key
 = "aws.s3.key";

/**
 * The part number of the part being uploaded in a multipart-upload operation. This is a positive integer between 1 and 10,000.
 * <p>
 * The @code part_number @endcode attribute is only applicable to the <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part.html">upload-part</a>
 * and <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part-copy.html">upload-part-copy</a> operations.
 * The @code part_number @endcode attribute corresponds to the @code --part-number @endcode parameter of the
 * <a href="https://docs.aws.amazon.com/cli/latest/reference/s3api/upload-part.html">upload-part operation within the S3 API</a>.
 */
static constexpr const char *kAwsS3PartNumber
 = "aws.s3.part_number";

/**
 * Upload ID that identifies the multipart upload.
 * <p>
 * The @code upload_id @endcode attribute applies to S3 multipart-upload operations and corresponds to the @code --upload-id @endcode parameter
 ...
 * </ul>
 */
static constexpr const char *kAwsS3UploadId
 = "aws.s3.upload_id";

/**
 * The ARN of the Secret stored in the Secrets Mangger
 */
static constexpr const char *kAwsSecretsmanagerSecretArn
 ...
 */
static constexpr const char *kAwsSnsTopicArn
 = "aws.sns.topic.arn";

/**
 * The URL of the AWS SQS Queue. It's a unique identifier for a queue in Amazon Simple Queue Service (SQS) and is used to access the queue and perform actions on it.
 */
static constexpr const char *kAwsSqsQueueUrl
 = "aws.sqs.queue.url";

/**
 * The ARN of the AWS Step Functions Activity.
 */
static constexpr const char *kAwsStepFunctionsActivityArn
