 ...
 */
static constexpr const char *kHwBatteryCapacity
 = "hw.battery.capacity";
 ...
 */
static constexpr const char *kHwBatteryChemistry
 = "hw.battery.chemistry";

/**
 * The current state of the battery
 */
static constexpr const char *kHwBatteryState
 = "hw.battery.state";

/**
 * BIOS version of the hardware component
 */
static constexpr const char *kHwBiosVersion
 = "hw.bios_version";

/**
 * Driver version for the hardware component
 */
static constexpr const char *kHwDriverVersion
 = "hw.driver_version";

/**
 * Type of the enclosure (useful for modular systems)
 */
static constexpr const char *kHwEnclosureType
 = "hw.enclosure.type";

/**
 * Firmware version of the hardware component
 */
static constexpr const char *kHwFirmwareVersion
 = "hw.firmware_version";

/**
 * Type of task the GPU is performing
 */
static constexpr const char *kHwGpuTask
 = "hw.gpu.task";
 ...
 */
static constexpr const char *kHwLimitType
 = "hw.limit_type";

/**
 * RAID Level of the logical disk
 */
static constexpr const char *kHwLogicalDiskRaidLevel
 = "hw.logical_disk.raid_level";

/**
 * State of the logical disk space usage
 */
static constexpr const char *kHwLogicalDiskState
 = "hw.logical_disk.state";

/**
 * Type of the memory module
 */
static constexpr const char *kHwMemoryType
 = "hw.memory.type";

/**
 * Descriptive model name of the hardware component
 */
static constexpr const char *kHwModel
 = "hw.model";
 ...
 */
static constexpr const char *kHwNetworkLogicalAddresses
 = "hw.network.logical_addresses";

/**
 * Physical address of the adapter (e.g. MAC address, or WWNN)
 */
static constexpr const char *kHwNetworkPhysicalAddress
 ...
 */
static constexpr const char *kHwPhysicalDiskSmartAttribute
 = "hw.physical_disk.smart_attribute";

/**
 * State of the physical disk endurance utilization
 */
static constexpr const char *kHwPhysicalDiskState
 = "hw.physical_disk.state";

/**
 * Type of the physical disk
 */
static constexpr const char *kHwPhysicalDiskType
 = "hw.physical_disk.type";

/**
 * Location of the sensor
 */
static constexpr const char *kHwSensorLocation
 = "hw.sensor_location";

/**
 * Serial number of the hardware component
 */
static constexpr const char *kHwSerialNumber
 = "hw.serial_number";
 ...
 */
static constexpr const char *kHwTapeDriveOperationType
 ...
 */
static constexpr const char *kHwVendor
 = "hw.vendor";
