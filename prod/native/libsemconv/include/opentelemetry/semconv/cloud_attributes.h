 ...
 */
static constexpr const char *kCloudAccountId
 = "cloud.account.id";
 ...
 */
static constexpr const char *kCloudAvailabilityZone
 ...
 */
static constexpr const char *kCloudPlatform
 = "cloud.platform";

/**
 * Name of the cloud provider.
 */
static constexpr const char *kCloudProvider
 = "cloud.provider";
 ...
 */
static constexpr const char *kCloudRegion
 = "cloud.region";
 ...
 * so it may be necessary to set @code cloud.resource_id @endcode as a span attribute instead.
 * <p>
 * The exact value to use for @code cloud.resource_id @endcode depends on the cloud provider.
 ...
 * </ul>
 */
static constexpr const char *kCloudResourceId
 = "cloud.resource_id";
