 ...
 *
 * @deprecated
 * {"note": "Replaced by @code client.address @endcode.", "reason": "renamed", "renamed_to": "client.address"}
 */
...
/**
 * Deprecated, use @code network.protocol.name @endcode and @code network.protocol.version @endcode instead.
 *
 * @deprecated
 * {"note": "Split into @code network.protocol.name @endcode and @code network.protocol.version @endcode", "reason": "uncategorized"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code http.request.method @endcode.", "reason": "renamed", "renamed_to": "http.request.method"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 * <p>
 * The @code User-Agent @endcode header is already captured in the @code user_agent.original @endcode attribute.
 ...
 * Examples:
 * <ul>
 *   <li>A header @code Content-Type: application/json @endcode SHOULD be recorded as the @code http.request.header.content-type @endcode
 * attribute with value @code ["application/json"] @endcode.</li>
 *   <li>A header @code X-Forwarded-For: 1.2.3.4, 1.2.3.5 @endcode SHOULD be recorded as the @code http.request.header.x-forwarded-for @endcode
 * attribute with value @code ["1.2.3.4", "1.2.3.5"] @endcode or @code ["1.2.3.4, 1.2.3.5"] @endcode depending on the HTTP library.</li>
 * </ul>
 */
static constexpr const char *kHttpRequestHeader
 = "http.request.header";
 ...
 * <p>
 * If the HTTP instrumentation could end up converting valid HTTP request methods to @code _OTHER @endcode, then it MUST provide a way to override
 * the list of known HTTP methods. If this override is done via environment variable, then the environment variable MUST be named
 * OTEL_INSTRUMENTATION_HTTP_KNOWN_METHODS and support a comma-separated list of case-sensitive known HTTP methods
 * (this list MUST be a full override of the default known method, it is not a list of known methods in addition to the defaults).
 * <p>
 * HTTP method names are case-sensitive and @code http.request.method @endcode attribute value MUST match a known HTTP method name exactly.
 * Instrumentations for specific web frameworks that consider HTTP methods to be case insensitive, SHOULD populate a canonical equivalent.
 * Tracing instrumentations that do so, MUST also set @code http.request.method_original @endcode to the original value.
 */
static constexpr const char *kHttpRequestMethod
 = "http.request.method";

/**
 * Original HTTP method sent by the client in the request line.
 */
static constexpr const char *kHttpRequestMethodOriginal
 ...
 */
static constexpr const char *kHttpRequestResendCount
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code http.request.body.size @endcode.", "reason": "renamed", "renamed_to": "http.request.body.size"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 * Examples:
 * <ul>
 *   <li>A header @code Content-Type: application/json @endcode header SHOULD be recorded as the @code http.request.response.content-type @endcode
 * attribute with value @code ["application/json"] @endcode.</li>
 *   <li>A header @code My-custom-header: abc, def @endcode header SHOULD be recorded as the @code http.response.header.my-custom-header @endcode
 * attribute with value @code ["abc", "def"] @endcode or @code ["abc, def"] @endcode depending on the HTTP library.</li>
 * </ul>
 */
static constexpr const char *kHttpResponseHeader
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code http.response.body.size @endcode.", "reason": "renamed", "renamed_to": "http.response.body.size"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 * <p>
 * A static path segment is a part of the route template with a fixed, low-cardinality value. This includes literal strings like @code /users/ @endcode and placeholders that
 * are constrained to a finite, predefined set of values, e.g. @code {controller} @endcode or @code {action} @endcode.
 * <p>
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code url.scheme @endcode.", "reason": "renamed", "renamed_to": "url.scheme"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code http.response.status_code @endcode.", "reason": "renamed", "renamed_to": "http.response.status_code"}
 */
OPENTELEMETRY_DEPRECATED
 ...
 *
 * @deprecated
 * {"note": "Replaced by @code user_agent.original @endcode.", "reason": "renamed", "renamed_to": "user_agent.original"}
 */
OPENTELEMETRY_DEPRECATED
