 ...
 */
static constexpr const char *kNetworkLocalPort
 = "network.local.port";

/**
 * Peer address of the network connection - IP address or Unix domain socket name.
 */
static constexpr const char *kNetworkPeerAddress
 = "network.peer.address";

/**
 * Peer port number of the network connection.
 */
static constexpr const char *kNetworkPeerPort
 = "network.peer.port";
 ...
 */
static constexpr const char *kNetworkProtocolName
 ...
 */
static constexpr const char *kNetworkProtocolVersion
 ...
 */
static constexpr const char *kNetworkTransport
 = "network.transport";
