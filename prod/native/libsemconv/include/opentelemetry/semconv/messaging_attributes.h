 ...
 */
static constexpr const char *kMessagingBatchMessageCount
 ...
 * <p>
 * Semantic conventions for individual messaging systems SHOULD document whether @code messaging.consumer.group.name @endcode is applicable and what it means in the context of that system.
 */
static constexpr const char *kMessagingConsumerGroupName
 = "messaging.consumer.group.name";

/**
 * A boolean that is true if the message destination is anonymous (could be unnamed or have auto-generated name).
 */
static constexpr const char *kMessagingDestinationAnonymous
 ...
 */
static constexpr const char *kMessagingDestinationName
 = "messaging.destination.name";

/**
 * The identifier of the partition messages are sent to or received from, unique within the @code messaging.destination.name @endcode.
 */
 ...
 * <p>
 * Semantic conventions for individual messaging systems SHOULD document whether @code messaging.destination.subscription.name @endcode is applicable and what it means in the context of that system.
 */
 ...
 */
static constexpr const char *kMessagingDestinationTemplate
 = "messaging.destination.template";

/**
 * A boolean that is true if the message destination is temporary and might not exist anymore after messages are processed.
 */
static constexpr const char *kMessagingDestinationTemporary
...
/**
 * Message keys in Kafka are used for grouping alike messages to ensure they're processed on the same partition. They differ from @code messaging.message.id @endcode in that they're not unique. If the key is @code null @endcode, the attribute MUST NOT be set.
 * <p>
 * If the key type is not string, it's string representation has to be supplied for the attribute. If the key has no unambiguous, canonical string form, don't include its value.
 */
static constexpr const char *kMessagingKafkaMessageKey
 ...
 */
static constexpr const char *kMessagingKafkaMessageTombstone
 = "messaging.kafka.message.tombstone";

/**
 * The offset of a record in the corresponding Kafka partition.
 */
static constexpr const char *kMessagingKafkaOffset
 ...
 */
static constexpr const char *kMessagingMessageBodySize
 = "messaging.message.body.size";

/**
 * The conversation ID identifying the conversation to which the message belongs, represented as a string. Sometimes called "Correlation ID".
 */
static constexpr const char *kMessagingMessageConversationId
 ...
 * size should be used.
 */
static constexpr const char *kMessagingMessageEnvelopeSize
 = "messaging.message.envelope.size";

/**
 * A value used by the messaging system as an identifier for the message, represented as a string.
 */
static constexpr const char *kMessagingMessageId
 ...
 */
static constexpr const char *kMessagingOperationName
 ...
 */
static constexpr const char *kMessagingOperationType
 ...
 */
static constexpr const char *kMessagingRocketmqMessageGroup
 = "messaging.rocketmq.message.group";

/**
 * Key(s) of message, another way to mark message besides message id.
 */
static constexpr const char *kMessagingRocketmqMessageKeys
 = "messaging.rocketmq.message.keys";

/**
 * The secondary classifier of message besides topic.
 */
static constexpr const char *kMessagingRocketmqMessageTag
 = "messaging.rocketmq.message.tag";

/**
 * Type of message.
 */
static constexpr const char *kMessagingRocketmqMessageType
 = "messaging.rocketmq.message.type";

/**
 * Namespace of RocketMQ resources, resources in different namespaces are individual.
 */
static constexpr const char *kMessagingRocketmqNamespace
 ...
 * <p>
 * The actual messaging system may differ from the one known by the client. For example, when using Kafka client libraries to communicate with Azure Event Hubs, the @code messaging.system @endcode is set to @code kafka @endcode based on the instrumentation's best knowledge.
 */
static constexpr const char *kMessagingSystem
 = "messaging.system";
