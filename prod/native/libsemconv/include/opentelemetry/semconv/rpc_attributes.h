 ...
 */
static constexpr const char *kRpcConnectRpcErrorCode
 ...
 */
static constexpr const char *kRpcGrpcStatusCode
 = "rpc.grpc.status_code";

/**
 * @code error.code @endcode property of response if it is an error response.
 */
static constexpr const char *kRpcJsonrpcErrorCode
 = "rpc.jsonrpc.error_code";

/**
 * @code error.message @endcode property of response if it is an error response.
 */
static constexpr const char *kRpcJsonrpcErrorMessage
 = "rpc.jsonrpc.error_message";

/**
 * @code id @endcode property of request or response. Since protocol allows id to be int, string, @code null @endcode or missing (for notifications), value is expected to be cast to string for simplicity. Use empty string in case of @code null @endcode value. Omit entirely if this is a notification.
 */
static constexpr const char *kRpcJsonrpcRequestId
 = "rpc.jsonrpc.request_id";

/**
 * Protocol version as in @code jsonrpc @endcode property of request/response. Since JSON-RPC 1.0 doesn't specify this, the value can be omitted.
 */
static constexpr const char *kRpcJsonrpcVersion
 = "rpc.jsonrpc.version";

/**
 * Compressed size of the message in bytes.
 */
static constexpr const char *kRpcMessageCompressedSize
 = "rpc.message.compressed_size";

/**
 * MUST be calculated as two different counters starting from @code 1 @endcode one for sent messages and one for received message.
 * <p>
 * This way we guarantee that the values will be consistent between different implementations.
 */
static constexpr const char *kRpcMessageId
 = "rpc.message.id";

/**
 * Whether this is a received or sent message.
 */
static constexpr const char *kRpcMessageType
 = "rpc.message.type";

/**
 * Uncompressed size of the message in bytes.
 */
static constexpr const char *kRpcMessageUncompressedSize
 ...
 */
static constexpr const char *kRpcSystem
 = "rpc.system";
