...
function(otel_get_git_version PROJECT_VERSION SIMPLE_VERSION GIT_REVISION_HASH)
...
function(otel_git_get_hash OUTPUT_HASH)
    block(SCOPE_FOR VARIABLES)
    set(IS_DIRTY false)
    ...
    # message(STATUS "otel_git_get_hash = ${TMP_OUTPUT_HASH}")
