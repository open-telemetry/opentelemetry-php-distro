...
static void getDiagnosticInformation(std::ostream &out, opentelemetry::php::PhpBridgeInterface const &bridge) {
    out << std::setfill(detail::separator) << std::setw(detail::separatorWidth) << detail::separator << std::endl;
    out << "OpenTelemetry PHP distribution diagnostics:" << std::endl;
    out << std::setfill(detail::separator) << std::setw(detail::separatorWidth) << detail::separator << std::endl;
...
void storeDiagnosticInformation(std::string_view outputFileName, opentelemetry::php::PhpBridgeInterface const &bridge) {
    std::ofstream out;
