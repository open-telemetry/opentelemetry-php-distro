...
TEST_F(CommonUtilsTest, sanitizeKeyValueString) {
    ...
    ASSERT_EQ(sanitizeKeyValueString("SOME_API_KEY"s, "SOME_API_KEY=supersecret"s), "SOME_API_KEY=***"s);
    ASSERT_EQ(sanitizeKeyValueString("SOME_API_KEY"s, "SOME_API_KEY=\"aaa\""s), "SOME_API_KEY=***"s);
    ASSERT_EQ(sanitizeKeyValueString("SOME_API_KEY"s, "THIS IS A TEXT SOME_API_KEY=\"aaa\" EXAMPLE"s), "THIS IS A TEXT SOME_API_KEY=*** EXAMPLE"s);
    ASSERT_EQ(sanitizeKeyValueString("SOME_API_KEY"s, "THIS IS A TEXT SOME_API_KEY=\"aaa with spaces\" EXAMPLE"s), "THIS IS A TEXT SOME_API_KEY=*** EXAMPLE"s);
}
...
TEST_F(CommonUtilsTest, getEnvName) {
    ASSERT_EQ(getEnvName("basic_option"), "OTEL_PHP_BASIC_OPTION"s);
    ASSERT_EQ(getEnvName("OtherOption"), "OTEL_PHP_OTHEROPTION"s);
}
...
TEST_F(CommonUtilsTest, parseLogFeatures_UnknownAndCorrectFeature) {
    ...
    auto found = features.find(opentelemetry::php::LogFeature::ALL);
...
TEST_F(CommonUtilsTest, parseLogFeatures_MultipleFeatures) {
    ...
    {
        auto found = features.find(opentelemetry::php::LogFeature::TRANSPORT);
        ASSERT_NE(found, std::end(features));
