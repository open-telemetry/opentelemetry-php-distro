...
private:
    void convertResourceSpans(opentelemetry::php::AutoZval &resourceInfo, opentelemetry::proto::trace::v1::ResourceSpans *out) {
    ...
    void convertScopeSpans(opentelemetry::php::AutoZval &instrumentationScope, opentelemetry::proto::trace::v1::ScopeSpans *out) {
    ...
    opentelemetry::proto::trace::v1::Status_StatusCode convertStatusCode(std::string_view status) {
        ...
        using namespace opentelemetry::utils::string_view_literals;
        auto iStatus = opentelemetry::utils::traits_cast<opentelemetry::utils::CiCharTraits>(status);
    ...
    int addRemoteFlags(opentelemetry::php::AutoZval &spanContext, int baseFlags) {
        using namespace std::string_view_literals;
        int flags = baseFlags;
    ...
    int buildFlagsForSpan(opentelemetry::php::AutoZval &spanContext, opentelemetry::php::AutoZval &parentSpanContext) {
    ...
    int buildFlagsForLink(opentelemetry::php::AutoZval &linkSpanContext) {
    ...
    void convertSpan(opentelemetry::php::AutoZval const &span, opentelemetry::proto::trace::v1::Span *out) {
