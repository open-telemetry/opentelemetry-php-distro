...
function generate_rows_to_test_sepcial_cases () {
    ...
    echo "${php_version_dot_separated},${package_type},${test_app_code_host_kind},${test_group},prod_log_level_syslog=TRACE,scoped_deps_enabled=false"
    ...
    package_type='rpm'
    local test_app_code_host_kind="${test_app_code_host_kinds[0]}"
    echo "${php_version_dot_separated},${package_type},${test_app_code_host_kind},${test_group},scoped_deps_enabled=false"
}
